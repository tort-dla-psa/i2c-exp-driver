...
static PyObject * onionI2C_new(PyTypeObject *type, PyObject *args, PyObject *kwds) {
	OnionI2CObject *self;
...
static int onionI2C_init(OnionI2CObject *self, PyObject *args, PyObject *kwds) {
	int 	adapter 	= -1;
...
static PyObject * onionI2C_close(OnionI2CObject *self) {
	// reset the params
	self->adapterNum	= -1;
...
static void onionI2C_dealloc(OnionI2CObject *self) {
...
static PyObject * onionI2C_setVerbosity(OnionI2CObject *self, PyObject *args) {
	int 		verbose;
...
static PyObject * onionI2C_readBytes(OnionI2CObject *self, PyObject *args) {
